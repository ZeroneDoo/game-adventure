	...
	if (data.mati == undefined || data.mati == false){
		if (data.rotasi == 0) {	
			if (data.skalaX == 1 && data.skalaY == 1){
				konten.drawImage(data.img, frameX * data.lebar, frameY * data.tinggi, data.lebar, data.tinggi, data.x-(data.lebar*game.skalaSprite)/2, data.y-(data.tinggi*game.skalaSprite)/2, data.lebar*game.skalaSprite, data.tinggi*game.skalaSprite);
			}else{
				konten.save();
				konten.translate(data.x, data.y);
				konten.scale(data.skalaX, data.skalaY);
				konten.drawImage(data.img, frameX * data.lebar, frameY * data.tinggi, data.lebar, data.tinggi, -(data.lebar*game.skalaSprite)/2, -(data.tinggi*game.skalaSprite)/2, data.lebar*game.skalaSprite, data.tinggi*game.skalaSprite);
				konten.restore();
			}
		}else{
			//gambar berotasi
